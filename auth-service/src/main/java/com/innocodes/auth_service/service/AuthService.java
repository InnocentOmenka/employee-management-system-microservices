...
public interface AuthService {
    ...
    /**
     * Registers a new user. Only Admin users can perform this action.
     *
     * @param request User registration details
     * @param email   Email of the admin performing the registration
     * @param token   JWT token of the admin
     * @return ApiResponse containing the registered user's details
     */
    ApiResponse<UserResponse> registerUser(UserRequest request, String email, String token);
...
//import com.innocodes.auth_service.utils.RoleValidator;
